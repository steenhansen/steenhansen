...
| **Elixir** -  Phoenix, LiveView, SVG<br> [GIT : elixir-liveview-snake][esg_g] <br><br>[LIVE SITE : multi-player multi-game online snake game ][esg_w]| [<img src="./images/list-elixir.webp" style ="object-fit: cover;   object-position: 0px 16%;" height="100" width="444" >](https://evening-eyrie-25210-f2edb2eac607.herokuapp.com/images/list-elixir.webp "click to see full screen size") | 
